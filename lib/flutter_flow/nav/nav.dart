...
class AppStateNotifier extends ChangeNotifier {
  LogitexAppFirebaseUser? initialUser;
  LogitexAppFirebaseUser? user;
  ...
  void update(LogitexAppFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? InicialWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => ChatconversaWidget(
